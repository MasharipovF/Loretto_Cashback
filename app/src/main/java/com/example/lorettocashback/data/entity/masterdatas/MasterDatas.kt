...
data class Warehouses(
    ...
    @SerializedName("U_inWhs")
    var InWarehouseCode: String? = null,

    @SerializedName("U_brWhs")
    var BrWarehouseCode: String? = null,

    @SerializedName("U_mainWhs")
    var MainWarehouseCode: String? = null,

    @SerializedName("U_whsType")
    var WarehouseType: Int? = null,
