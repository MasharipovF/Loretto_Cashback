...
data class OutOfStockReportVal(
    @SerializedName("@odata.context")
    val odataContext: String? = null,
    @SerializedName("@odata.nextLink")
    val odataNextLink: String? = null,
    @SerializedName("value")
    val value: List<OutOfStockReport>? = null
)

data class OutOfStockReport(
    ...
    val outOfStockQty: BigDecimal = BigDecimal.ZERO,
    @SerializedName("OutOfStockSum")
    val outOfStockSum: BigDecimal = BigDecimal.ZERO,
